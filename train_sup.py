...
def train_val(config, model, train_loader, val_loader, criterion):
    ...
    for epoch in range(epochs):
        ...
        for idx, batch in enumerate(train_loader):
            ...
            writer.add_scalar('Train/IOU', iou_train, iter)
            if config.log == True: 
        ...
        writer.add_scalar('Val/loss', loss_val_epoch.item(), epoch)
        writer.add_scalar('Val/Di_score', dice_val_epoch, epoch)
        writer.add_scalar('Val/IOU', iou_val_epoch, epoch)
        if config.log == True: 
