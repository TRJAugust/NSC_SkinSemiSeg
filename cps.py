...
def train_val(config, model1, model2, train_loader, val_loader, criterion):
    ...
    for epoch in range(epochs):
        ...
        for idx, (batch, batch_w_s) in enumerate(source_dataset):
            ...
            print(sup_batch_len, unsup_batch_len)
            ...
            losses_u1 = []
            for function in criterion:
                losses_u1.append(function(outputs_u1, outputs_u2))
                
            losses_u2 = []
            for function in criterion:
                losses_u2.append(function(outputs_u2, outputs_u1))
            #======================================================================================================
            ...
            if config.log == True:    
                wandb.log({'Train/loss': loss.item(), 
                       'Train/IOU_1':iou_train_1,
                       'Train/IOU_2':iou_train_2})
        ...
        if config.log == True:
            wandb.log({'Val1/loss': loss_val_epoch.item(), 'Val1/Dice_score': dice_val_epoch, 'Val1/IOU': iou_val_epoch})
        ...
        loss_val_epoch, dice_val_epoch, iou_val_epoch = loss_val_sum/num_val, dice_val_sum/num_val, iou_val_sum/num_val
        if config.log == True:
            wandb.log({'Val2/loss': loss_val_epoch.item(), 'Val2/Dice_score': dice_val_epoch, 'Val2/IOU': iou_val_epoch})
